...
/* USER CODE BEGIN PV */
/* Private variables ---------------------------------------------------------*/
extern uint8_t usb_receive_buffer[128];
...
static int8_t CDC_Receive_HS(uint8_t* Buf, uint32_t *Len)
{
  ...
  memcpy(&usb_receive_buffer[usb_receive_buffer_index], Buf, *Len);
  usb_receive_buffer_index += *Len;
  if(usb_receive_buffer_index >= 128){
    usb_receive_buffer_index = 0;
  }
  __atomic_store_n(&g_usb_receive_flag, 1, __ATOMIC_RELAXED);
